...
Andy’s original scripts are comprehensive and highly educational, but new users may find them difficult to read, modify, or adapt for flexible batch processing. This pipeline addresses those limitations by providing a cleaner and more modular scripting framework while preserving methodological consistency. These scripts are expected to provide convenience for **beginners who are following Andy's tutorial**. 
